...
class Display:
    ...
    def display_result(self, frame_top, frame_side, side_seg_results, top_seg_results, top_det_results, side_det_results, scoring, state, frame_counter, fps):
        ...
        m_weights_right_tweezers = scoring['measuring_score_weights_tweezers']
